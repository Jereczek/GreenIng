package acceptanceTests.onlinegame;
...
public class OnlineGameAcceptanceTest {
    private final static String CALCULATE_PATH = "/onlinegame/calculate";

    private final static Map<String, String> listOfExamples = Map.of(
            "payloads/onlinegame/example_request.json", "payloads/onlinegame/example_response.json");
    @Inject
